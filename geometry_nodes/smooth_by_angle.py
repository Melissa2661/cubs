...
def smooth_by_angle_1_node_group(node_tree_names: dict[typing.Callable, str]):
...
if __name__ == "__main__":
    ...
    smooth_by_angle = smooth_by_angle_1_node_group(node_tree_names)
    node_tree_names[smooth_by_angle_1_node_group] = smooth_by_angle.name
