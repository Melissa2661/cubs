...
* **Capsule of Ico Spheres**: Make capsules of varying height / radius that consist of equilateral triangles.
* **Smooth by Angle**: A copy of the built-in smooth by angle node (the built-in node is not usable out-of-the-box in scripts)
